...
export const createRonde1gPatch = (api: HydraApi): HydraPatchController => {
  ...
  const base = osc(fLow, 0, () => (L() + M1() + M2()) * 0.2 - Hsoft() * 0.5)
